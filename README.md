...
<head>
  <meta charset="UTF-8" />
  <title>Designer Profissional - Certificações em TI</title>
  <style>
    body {
      margin: 0;
    ...
    .cert {
      ...
      padding: 1rem;
      margin: 1rem 0;
      border-left: 5px solid #5ac8fa; /* azul claro */
      border-radius: 5px;
    }
    ...
    /* Estilo da tabela e corpo abaixo */
...
<body>
  ...
  <div class="container">
    ...
    <h2>Conexão entre Certificações e Evolução Profissional</h2>
    <p>
  ...
  <div class="questionario">
    ...
    <form>
      ...
      <label for="cert">Qual certificação você gostaria de obter?</label>
